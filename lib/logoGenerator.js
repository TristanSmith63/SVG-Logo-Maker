...
async function generateLogo() {
  try {
    ...
    const svgContent = `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg">${shapeObject.render()}<text x="150" y="120" fill="${textColor}" font-size="24" text-anchor="middle">${text}</text></svg>`;
    writeSVGToFile(svgContent, 'examples/logo.svg');
